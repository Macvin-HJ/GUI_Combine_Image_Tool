...
def add_file():
    files = filedialog.askopenfilenames(title="Select an image file",\
                                        ...
                                        initialdir=r"C:\Desktop\Project\python\gui_project")
    for file in files:
...
def merge_image():
    ...
    dest_path = os.path.join(txt_dest_path.get(), "Combine Image Tool.jpg")
    result_img.save(dest_path)
    msgbox.showinfo("Notice", "Operation completed.")
